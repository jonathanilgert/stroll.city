...
data.hunts = [
  ...
  },
  {
    ...
    slug: 'full-hunt',
    name: 'Full Hunt',
    blurb: 'Eight curated stops, no clock, proof photos, a postcard finish and a possible final-stop treat.',
  ...
  },
  {
    ...
    slug: 'loop-race',
    name: 'Loop Race',
    blurb: 'Eight stops, rotated starts, live leaderboard. Destinations stay hidden while racing.',
